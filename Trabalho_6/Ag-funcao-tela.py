...
class Tela:
    def __init__(self):
        layout = [
                [sg.Text('Tamanho cromossomo: ', size=(15,0)), sg.Input(key='tamCromo',size=(10,0))],
                ...
                [sg.Radio('Cruz 1 ponto', "cruza",size=(15,0), key='radio_cruz1', default=True)], 
                [sg.Radio('Cruz 2 pontos', "cruza",size=(15,0), key='radio_cruz2',default=False)],
                [sg.Button('rodar', size=(15,0))],
                ...
                [sg.Text('Aptidao: '),sg.Text(key='aptidao', size=(10,0))],
            ]
    ...
    def display(self):
        while True:
            ...
            tamCromossomo = int(self.values['tamCromo'])
            ...
            geracaofinal, x, y, aptidaofinal = agfuncao.alg_genetico(tamCromossomo, tamPopulacao, pc, pm, numgeracoes, elite, selecao, k, cruzamento)
